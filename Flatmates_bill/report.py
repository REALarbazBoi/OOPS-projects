...
class PdfReport:
    ...
    as their names, their due amounts and the period of bill
    """
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        # https://pyfpdf.readthedocs.io/en/latest/Tutorial/index.html (Docs)
        ...
        pdf.cell(w=0, h=80, txt="Flatmatebill", border=0, align="C", ln=1)
